...
import AgentMascotScene from "./animations/AgentMascotScene";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden grid-bg">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 text-center pt-20">
        ...
        {/* Mascot scene — mission control environment */}
        <div className="relative mx-auto w-full max-w-2xl mb-12">
          <AgentMascotScene
            className="w-full drop-shadow-[0_0_40px_rgba(57,255,20,0.3)]"
          />
        </div>
